                ...
                <div className="grid grid-cols-1 gap-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 pb-32">
                        ...
                        <div className="md:w-1/2 text-center sm:text-start pt-20 sm:px-12">
                            <h2 className="text-4xl font-bold text-main mb-4 hover:text-blue-500 duration-200">75x48x23cm</h2>
                    ...
                    <div className="md:w-1/2 shadow-3xl relative ">
                        ...
                        <div className="md:w-1/2 text-center sm:text-start pt-20 sm:px-12">
                            <h2 className="text-4xl font-bold text-main mb-4 hover:text-blue-500 duration-200">80x50x24cm</h2>
                            <p className="text-gray-700 text-2xl">
                                {t('info')}
                            </p>
                        </div>
